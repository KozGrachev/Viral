...
export const sources = [
  ...
  {
    name: 'evil ex',
    connections: ['mother-in-law', 'cousin', 'fran from HR', 'guy at the bus stop'],
    category: 'relations'
  },
  {
  ...
  {
    name: 'crazy dave',
    connections: ['guy at the bus stop', 'opinionated grandpa', 'ASDA', 'illuminatify'],
    category: 'relations'
  },
  {
  ...
  {
    name: 'youtube',
    connections: ['illuminatify', 'ASDA', 'intagram'],
    category: 'social'
  },
  {
    name: 'intagram',
